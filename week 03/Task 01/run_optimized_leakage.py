...
print("--- Step 1: Querying Active Clients from dim_clients ---")
# Get active clients from dim_clients (very fast!)
clients_df = con.sql("""
...
print("Active clients to query:", active_clients)

print("\n--- Step 2: Compiling features and labels for active clients ---")
# We use client filter directly in the FROM/WHERE clause of our Parquet scans
query = f"""
...
print("\n--- Step 4: Training WITHOUT Leakage (Honest) ---")
