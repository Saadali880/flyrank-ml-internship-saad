...
target_client = 'client_0797ff3a1fc9a6a5'

log(f"Querying features and labels for {target_client} in March/April 2026...")
query = f"""
...
df = con.sql(query).df()
log(f"Query complete! Compiled shape: {df.shape}")
print(df.head())
